...
function downloadResults() {
  ...
  const powerloss = document.getElementById("poloss").textContent;
  const efficiency = document.getElementById("eff").textContent;
  const A11 = document.getElementById("A11").textContent;
  const A22 = document.getElementById("A22").textContent;
  const B11 = document.getElementById("B11").textContent;
  const B22 = document.getElementById("B22").textContent;
  const C11 = document.getElementById("C11").textContent;
  const C22 = document.getElementById("C22").textContent;
